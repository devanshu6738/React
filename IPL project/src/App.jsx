...
method: 'GET',
headers: {
  'x-rapidapi-key': 'ccbb2c011bmshca041f8360ba07ep1898fajsn2242234902a4',
...
console.error(error);
 ...
 return(
  <div>
    {MatchData.map((data)=>(
      // <h1 key={i}>{data.matchDetailsMap.key}</h1>
      data.matchDetailsMap.match.map(singlematch=>(
        <h1>{singlematch.matchInfo.team1.teamSName} vs {singlematch.matchInfo.team2.teamSName} ,{singlematch.matchInfo.status}</h1>
      )
