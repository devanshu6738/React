...
try {
    ...
    return (
       ...
       </div>
       {
        ...
        <InPageNavigation team={[data.matchInfo.team1.name,data.matchInfo.team2.name]}>
            {
                fixedData.matchInfo.team1.playerDetails.map(data=>(
                    <p>
                        <h1>{data.fullName}</h1>
                        <p>{data.role}</p>
                    </p>
            ...
            {
                fixedData.matchInfo.team2.playerDetails.map(data=>(
                    <p>
                        <h1>{data.fullName}</h1>
                        <p>{data.role}</p>
                    </p>
