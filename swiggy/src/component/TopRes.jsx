...
function TopRes() {
  ...
  return (
    ...
    <div className='w-[78%] mx-auto overflow-x-hidden border-b-1 pb-12 border-gray-200 justify-center'>
    ...
    <div className='flex mt-4 gap-6 duration-300' style={{translate:`${value}%`}}>
      {
        data.map((items)=>(
         <div>
           <img src={`https://media-assets.swiggy.com/swiggy/image/upload/${items.info.cloudinaryImageId}`} alt="" className='min-w-[273px] h-[183px] rounded-2xl'/>  
         </div>
        ))
      }
      {
